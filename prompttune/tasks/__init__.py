...
from prompttune import Variable
from prompttune.engine import EngineLM
...
def load_task(task_name: str, evaluation_api: EngineLM, *args, **kwargs) -> Tuple[Dataset, Dataset, Callable]:
    ...
    if "object_counting" in task_name:
        from prompttune.loss import MultiFieldTokenParsedEvaluation
        from .big_bench_hard import BigBenchHard, string_based_equality_fn
        from prompttune.autograd.string_based_ops import StringBasedFunction
        ...
        from prompttune.tasks.gsm8k import GSM8K_DSPy
